...
O nucleo de notificacoes aplica melhor esforco a todos os contatos disponiveis: tenta e-mail quando existe e-mail, SMS quando existe telefone e ambos quando os dois existem. Falhas sao isoladas e registradas sem destinatario ou conteudo sensivel. O e-mail usa Mailpit local ou SMTP por configuracao; o SMS usa adapter de log local/CI ou Twilio por configuracao externa, com limite de 160 caracteres. A integracao com transicoes permanece no Dia 9. A politica detalhada esta em `docs/notifications.md`.
