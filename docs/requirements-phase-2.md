...
| F2-NOT-02 | Apos cada transicao persistida, tentar todos os canais disponiveis; falhas sao independentes, nao revertem status e operacoes invalidas nao notificam. | O dispatcher, as portas internas, as mensagens, o registro sanitizado de falhas e os adapters de e-mail e SMS foram implementados; a integracao com transicoes ainda nao existe. | Integracao com todos os casos de uso no Dia 9. | Matriz zero/e-mail/SMS/ambos e falhas independentes aprovadas; ausencia de envio apos rollback sera validada no Dia 9. | 6 e 9 | Parcial |
